...
contract WorkContract {
  ...
  event WorkContractIssued(bytes32 indexed workContractId, bytes workSubmission, uint256 paymentAmount, address indexed payoutAddress);
  ...
  function issueWorkContract(uint256 paymentAmount, address payoutAddress, bytes memory workSubmission) public returns (bytes32 workContractId) {
